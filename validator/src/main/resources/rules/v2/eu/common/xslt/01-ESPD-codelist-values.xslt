...
<xsl:stylesheet version="2.0" xmlns:cac="urn:X-test:UBL:Pre-award:CommonAggregate" xmlns:cbc="urn:X-test:UBL:Pre-award:CommonBasic" xmlns:espd-req="urn:X-test:UBL:Pre-award:QualificationApplicationRequest" xmlns:espd-resp="urn:X-test:UBL:Pre-award:QualificationApplicationResponse" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
...
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="ESPD Code List Business Rules">
      ...
      <svrl:ns-prefix-in-attribute-values prefix="espd-req" uri="urn:X-test:UBL:Pre-award:QualificationApplicationRequest" />
      <svrl:ns-prefix-in-attribute-values prefix="espd-resp" uri="urn:X-test:UBL:Pre-award:QualificationApplicationResponse" />
...
<!--PATTERN code-list-values-->
	...
	<!--RULE -->
<xsl:template match="cbc:ConfidentialityLevelCode" mode="M7" priority="1017">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Country/cbc:IdentificationCode" mode="M7" priority="1016">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:TypeCode" mode="M7" priority="1015">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="@currencyID" mode="M7" priority="1014">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:ValueCurrencyCode" mode="M7" priority="1013">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:AdditionalReferenceDocument/cbc:DocumentTypeCode" mode="M7" priority="1012">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:PartyIdentification/cbc:ID/@schemeID" mode="M7" priority="1011">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:EconomicOperatorParty/cac:Party/cbc:IndustryClassificationCode" mode="M7" priority="1010">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:EconomicOperatorParty/cac:EconomicOperatorRole/cbc:RoleCode" mode="M7" priority="1009">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( false() or ( (contains(translate('SCLEGMOERONOENRON','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) )">
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>Invalid value: '<xsl:text />
	...
	<!--RULE -->
<xsl:template match="@languageID" mode="M7" priority="1008">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:TenderingCriterion/cbc:EvaluationMethodTypeCode" mode="M7" priority="1007">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:ProcedureCode" mode="M7" priority="1006">
