...
public class Sandbox extends Master {
    ...
    public Sandbox(Navigator navigator) {
        ...
        { // IndicatorResponse
            ...
            IndicatorResponseForm indicatorResponseForm = new IndicatorResponseForm(indicatorResponse, "Indicator test case", false);
        ...
        { // DescriptionResponse
            ...
            DescriptionResponseForm descriptionResponseForm = new DescriptionResponseForm(descriptionResponse, "DescriptionResponse test case", false);
        ...
        { // DateResponseForm
            ...
            DateResponseForm dateResponseForm = new DateResponseForm(dateResponse, "DateResponse test case", false);
        ...
        { // QuantityResponseForm
            ...
            QuantityResponseForm quantityResponseForm = new QuantityResponseForm(quantityResponse, "QuantityResponse test case", false);
        ...
        { // QuantityYearResponseForm
            ...
            QuantityYearResponseForm quantityYearResponseForm = new QuantityYearResponseForm(quantityYearResponse, "QuantityYearResponse test case", false);
        ...
        { // QuantityIntegerResponseForm
            ...
            QuantityIntegerResponseForm quantityIntegerResponseForm = new QuantityIntegerResponseForm(quantityIntegerResponse, "QuantityIntegerResponse test case", false);
        ...
        { // AmountResponseForm
            ...
            AmountResponseForm amountResponseForm = new AmountResponseForm(amountResponse, "AmonuntResponse test case", false);
        ...
        { // CountryCodeResponseForm
            ...
            CountryCodeResponseForm countryCodeResponseForm = new CountryCodeResponseForm(countryCodeResponse, "CountryCodeResponse test case", false);
        ...
        { // PercentageResponseForm
            ...
            PercentageResponseForm percentageResponseForm = new PercentageResponseForm(percentageResponse, "PercentageResponse test case", false);
        ...
        { // PeriodResponseForm
            ...
            PeriodResponseForm percentageResponseForm = new PeriodResponseForm(periodResponse, "PeriodResponse test case", false);
            pageContent.addComponent(percentageResponseForm);
        ...
        { // EvidenceURLResponseForm
            ...
            ESPDEvidenceURLResponseForm evidenceURLResponseForm = new ESPDEvidenceURLResponseForm(evidenceURLResponse, "EvidenceURLResponse test case", false);
        ...
        { // EvidenceURLCodeResponseForm
            ...
            EvidenceURLCodeResponseForm evidenceURLCodeResponseForm = new EvidenceURLCodeResponseForm(evidenceURLCodeResponse, "EvidenceURLCodeResponse test case", false);
