...
public class ESPDResponseSchemaExtractorV1 implements SchemaExtractorV1 {
    ...
    protected eu.espd.schema.v1.ccv_commonaggregatecomponents_1.ResponseType extractResponse(Response response, ResponseTypeEnum respType) {
        ...
        switch (respType) {
            ...
            case PERCENTAGE:
                if (((PercentageResponse) response).getPercentage() != null) {
                    ...
                    rType.getPercent().setValue(((PercentageResponse) response)
                            .getPercentage()
