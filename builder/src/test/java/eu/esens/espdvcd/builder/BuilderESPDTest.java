...
public class BuilderESPDTest {
    ...
    public void createESPDRequestFromFile() throws Exception {
        ...
        ESPDRequest espd = espdBuiler.createESPDRequestFromXML(is);
    ...
    public void deselectExclusionCriterion() throws Exception {
        ...
        // Here we load an ESPD Request generated by the EU Service
        ESPDRequest originalEspd = espdBuiler.createESPDRequestFromXML(is);
        ...
        ESPDRequest importedEspd = espdBuiler.createESPDRequestFromXML(stream);
        stream.close();
