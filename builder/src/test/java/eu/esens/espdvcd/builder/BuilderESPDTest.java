...
//        System.out.println(XML);
    ...
    public void testCreateRegulatedESPDRequestV2WithPredefinedCriteria() throws BuilderException, RetrieverException {
        ...
        ESPDRequest req = BuilderFactory.V2.getModelBuilder().createESPDRequest();
        req.setCriterionList(extractor.getFullList());
    ...
    public void testCreateESPDRequestV2WithPredefinedCriteria() throws BuilderException, RetrieverException {
        CriteriaExtractor extractor = new PredefinedESPDCriteriaExtractor();
        ESPDRequest req = BuilderFactory.getOldModelBuilder().createESPDRequest();
        req.setCriterionList(extractor.getFullList());
...
//        CriteriaExtractor extractor = new PredefinedESPDCriteriaExtractor();
    ...
    public void createRegulatedV2ESPDResponseFromFile() throws Exception {
        ...
        // Here we load an ESPD Request generated by the EU Service
        // ESPDResponse espd = BuilderFactory.V2.getModelBuilder().importFrom(isRes).createESPDResponse();
        ESPDResponse espd = BuilderFactory.V2.getModelBuilder().importFrom(
                getClass().getResourceAsStream("/REGULATED-ESPDRequest-02.00.02.xml"))
                .createESPDResponse();
        Assert.assertNotNull(espd);

        // We create an XML from our simple model
        String XML = new XMLDocumentBuilderV2(espd).getAsString();
        Assert.assertNotNull(XML);
        System.out.println(XML);
    }
