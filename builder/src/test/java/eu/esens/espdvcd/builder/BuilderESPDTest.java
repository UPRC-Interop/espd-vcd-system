...
//    @Test
//    public void testPropertyKeysForRegulatedRequest() throws Exception {
//        ESPDRequest espdRequest = BuilderFactory.EDM_V2
//                .createRegulatedModelBuilder()
...
//
//    @Test
//    public void testPropertyKeysForRegulatedResponse() throws Exception {
//        ESPDResponse espdResponse = BuilderFactory.EDM_V2
//                .createRegulatedModelBuilder()
...
//
//    @Test
//    public void testPropertyKeysForSelfContainedRequest() throws Exception {
//        ESPDRequest espdRequest = BuilderFactory.EDM_V2
//                .createSelfContainedModelBuilder()
//                .importFrom(BuilderESPDTest.class.getResourceAsStream("/artefacts/selfcontained/da/2.1.0/UPRC-ESPD-Self-Contained-Request-2.1.0-Artefact-27-2-2019.xml"))
//                .createESPDRequest();
//
//
//        XMLDocumentBuilderV2 xmlDocumentBuilderV2 = BuilderFactory.EDM_V2
...
//    }
    ...
    public void testESPDRequestPDFV2() throws Exception {
        ...
        File targetFile = new File(System.getProperty("user.home") + "/Downloads/espd-request-tester.pdf");
        FileUtils.copyInputStreamToFile(pdfStream, targetFile);

        // Automatically open the downloaded PDF file
    ...
    public void testESPDResponsePDFV2() throws Exception {
        ...
        File targetFile = new File(System.getProperty("user.home") + "/Downloads/espd-response-tester.pdf");
        FileUtils.copyInputStreamToFile(pdfStream, targetFile);
    ...
    @Test
    public void createESPDRequestHTML() throws Exception {
        // Here we load an ESPD Request generated by the EU Service
        ESPDRequest espdRequest = BuilderFactory.EDM_V2
                .createRegulatedModelBuilder()
                .importFrom(BuilderESPDTest.class.getResourceAsStream("/artefacts/regulated/v2/2.1.0/UPRC-ESPD-Regulated-Request-2.1.0-Artefact-24-4-2019.xml"))
        ...
        TransformationService transformationService = new TransformationService();
        InputStream htmlStream = transformationService.createHtmlStream(espdRequest, EULanguageCodeEnum.EL);
        File targetFile = new File(System.getProperty("user.home") + "/Downloads/espd-request-tester.html");
        FileUtils.copyInputStreamToFile(htmlStream, targetFile);
    ...
    @Test
    public void createESPDResponseHTML() throws Exception {
        ESPDResponse espdResponse = BuilderFactory.EDM_V2
                .createRegulatedModelBuilder()
                .importFrom(BuilderESPDTest.class.getResourceAsStream("/artefacts/regulated/v2/2.1.0/UPRC-ESPD-Regulated-Response-2.1.0-Artefact-24-4-2019.xml"))
                .createESPDResponse();
        ...
        TransformationService transformationService = new TransformationService();
        InputStream htmlStream = transformationService.createHtmlStream(espdResponse, EULanguageCodeEnum.EL);

        File targetFile = new File(System.getProperty("user.home") + "/Downloads/espd-response-tester.html");
        FileUtils.copyInputStreamToFile(htmlStream, targetFile);
