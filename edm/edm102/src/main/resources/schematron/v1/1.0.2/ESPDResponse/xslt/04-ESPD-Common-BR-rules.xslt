...
<!--PATTERN common-br-rules-->
	...
	<!--RULE -->
<xsl:template match="/espd:ESPDResponse/cac:ProcurementProjectLot" mode="M11" priority="1009">
    <svrl:fired-rule context="/espd:ESPDResponse/cac:ProcurementProjectLot" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(cbc:ID!='0') )">
          ...
          <svrl:text>The current version of the ESPD Service does not allow for the
				specification of multiple lots. To ensure conformace with the current version of the ESPD Service the ID
				sub-element inside the element ProcurementProjectLot MUST be 0 (zero).
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:variable name="TypeCodeExclusion" select="/espd:ESPDResponse/ccv:Criterion/cbc:TypeCode[starts-with(., 'CRITERION.EXCLUSION.')]" />

	<!--RULE -->
<xsl:template match="/espd:ESPDResponse" mode="M11" priority="1007">
    <svrl:fired-rule context="/espd:ESPDResponse" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(string(cbc:ID))=false() )">
          ...
          <svrl:text>The element 'espd:ESPDResponse / cbc:ID' is mandatory
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(string(cbc:IssueDate))=false() )">
          ...
          <svrl:text>The element 'espd:ESPDResponse / cbc:IssueDate' is
				mandatory
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count( cac:AdditionalDocumentReference ) > 0">
          ...
          <svrl:text>The ESPDResponse MUST always contain one
				'AdditionalDocumentReference' element referring to the Contract Notice (CN) published in TeD
				(Publications Office).
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
	...
	<!--RULE -->
<xsl:template match="/espd:ESPDResponse/ccv:Criterion" mode="M11" priority="1006">
    <svrl:fired-rule context="/espd:ESPDResponse/ccv:Criterion" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/espd:ESPDResponse/ccv:Criterion/ccv:RequirementGroup" mode="M11" priority="1005">
    <svrl:fired-rule context="/espd:ESPDResponse/ccv:Criterion/ccv:RequirementGroup" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/espd:ESPDResponse/ccv:Criterion/ccv:RequirementGroup/ccv:Requirement" mode="M11" priority="1004">
    <svrl:fired-rule context="/espd:ESPDResponse/ccv:Criterion/ccv:RequirementGroup/ccv:Requirement" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(string(@responseDataType))=false() )">
          ...
          <svrl:text>The attribute 'responseDataType' is mandatory
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/espd:ESPDResponse/ccv:Criterion/ccv:LegislationReference" mode="M11" priority="1003">
    <svrl:fired-rule context="/espd:ESPDResponse/ccv:Criterion/ccv:LegislationReference" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(string(ccv-cbc:JurisdictionLevelCode))=false() )">
          ...
          <svrl:text>The element
				'ccv-cbc:JurisdictionLevelCode' is mandatory
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ccv:RequirementGroup/cbc:ID | ccv:RequirementGroup/ccv:Requirement/cbc:ID" mode="M11" priority="1002">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(@schemeAgencyID!='EU-COM-GROW') )">
          ...
          <svrl:text>The value of the attribute 'schemeAgencyID' must be
				'EU-COM-GROW'
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(@schemeID!='CriterionRelatedIDs') )">
          ...
          <svrl:text>The value of the attribute 'schemeID' must be
				'CriterionRelatedIDs'
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(@schemeVersionID!='1.0') )">
          ...
          <svrl:text>The value of the attribute 'schemeVersionID' must be '1.0'
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ccv:Criterion/cbc:ID" mode="M11" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/espd:ESPDResponse/cac:AdditionalDocumentReference" mode="M11" priority="1000">
    <svrl:fired-rule context="/espd:ESPDResponse/cac:AdditionalDocumentReference" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="( not(string(cbc:ID))=false() )">
          ...
          <svrl:text>The AdditionalDocumentReference referring to the CN published
				in TeD MUST use the element ID to identify the CN.
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(count(cbc:ID)=0) or not(cbc:DocumentTypeCode/text() = 'TED_CN') or ( (count(cbc:ID))=1 and (string-length(cbc:ID)=17 and substring(cbc:ID,5,3)='/S ' and substring(cbc:ID,11,1)='-'))">
          ...
          <svrl:text>
				The value of the ID MUST follow the pattern YYYY/S DDD-DDDDDD, where 'YYYY' is a year, '/S' is a
				constant label, and 'D' represent digits. Beware of the existence of a space (a blank) between the 'S'
				and the first 'D'.
			</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
