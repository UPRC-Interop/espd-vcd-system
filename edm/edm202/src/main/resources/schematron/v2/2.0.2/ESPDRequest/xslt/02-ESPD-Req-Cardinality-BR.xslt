...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="ESPD Request Cardinality Business Rules">
      <xsl:comment>
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">BR-REQ-CARD</xsl:attribute>
        <xsl:attribute name="name">BR-REQ-CARD</xsl:attribute>
        <xsl:apply-templates />
      </svrl:active-pattern>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>ESPD Request Cardinality Business Rules</svrl:text>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cbc:QualificationApplicationTypeCode)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cac:TenderingCriterion)">
