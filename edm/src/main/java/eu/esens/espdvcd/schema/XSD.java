...
public enum XSD {
    ...
    // xsd version 2
    ESPD_REQUEST_V2("urn:oasis:names:specification:ubl:schema:xsd:QualificationApplicationRequest-2", "", "xsd/v2/maindoc/UBL-QualificationApplicationRequest-2.2.xsd"),
