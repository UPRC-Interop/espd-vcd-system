...
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="Common Criterion Business Rules">
      ...
      <svrl:ns-prefix-in-attribute-values prefix="espd" uri="urn:X-test:UBL:Pre-award:QualificationApplicationRequest" />
      <svrl:active-pattern>
...
<xsl:template match="cac:TenderingCriterion" mode="M6" priority="1003">
    ...
    <xsl:variable name="ElementUUID" select="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.2.xml')//cac:TenderingCriterion[cbc:ID = $currentID]      else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.2.xml')//cac:TenderingCriterion[cbc:ID = $currentID]" />
...
<xsl:template match="cac:TenderingCriterionPropertyGroup | cac:SubsidiaryTenderingCriterionPropertyGroup" mode="M6" priority="1001">
    ...
    <xsl:variable name="applicationType" select="/*[1]/cbc:QualificationApplicationTypeCode" />
    <xsl:variable name="ElementUUID_SUB" select="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.2.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $currentID]      else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.2.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $currentID]" />
    <xsl:variable name="ParentUUID_SUB" select="$ElementUUID_SUB[parent::*[cbc:ID = $parentID]][1]" />
    <xsl:variable name="ElementUUID_T" select="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.2.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $currentID]      else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.2.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $currentID]" />
...
<xsl:template match="cac:TenderingCriterionProperty" mode="M6" priority="1000">
    ...
    <xsl:variable name="applicationType" select="/*[1]/cbc:QualificationApplicationTypeCode" />
    <xsl:variable name="ElementUUIDSTC" select="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.2.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty      else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.2.xml')//cac:SubsidiaryTenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty" />
    <xsl:variable name="ElementUUID_STCExists" select="(count($ElementUUIDSTC) > 0)" />
    <xsl:variable name="ElementUUIDTC" select="if ($applicationType!='SELFCONTAINED') then document('ESPD-CriteriaTaxonomy-REGULATED.V2.0.2.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty      else document('ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.2.xml')//cac:TenderingCriterionPropertyGroup[cbc:ID = $TCPropertyGroupID][1]/cac:TenderingCriterionProperty" />
