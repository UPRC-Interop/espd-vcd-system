...
<!--PATTERN BR-COM-OTH-->
	...
	<!--RULE -->
<xsl:template match="cac:AdditionalDocumentReference" mode="M6" priority="1006">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:UBLVersionID" mode="M6" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:ProfileID" mode="M6" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:ExpectedCode | cbc:IdentificationCode | cbc:ValueCurrencyCode | cbc:ProcedureCode | cbc:ProcurementTypeCode | cbc:ProcurementSubTypeCode" mode="M6" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:EndpointID" mode="M6" priority="1000">
