...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="ESPD Response Cardinality Business Rules">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>ESPD Response Cardinality Business Rules</svrl:text>

<!--PATTERN BR-RESP-CARD-->


	<!--RULE -->
<xsl:template match="espd:QualificationApplicationResponse" mode="M5" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="(cac:TenderingCriterionResponse)">
