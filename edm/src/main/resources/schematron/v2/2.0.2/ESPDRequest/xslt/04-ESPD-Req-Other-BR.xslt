...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="ESPD Request Other Business Rules">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>ESPD Request Other Business Rules</svrl:text>

<!--PATTERN BR-REQ-OTHER-->


	<!--RULE -->
<xsl:template match="cbc:CustomizationID" mode="M6" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="text()='urn:www.cenbii.eu:transaction:biitrdm070:ver3.0'">
