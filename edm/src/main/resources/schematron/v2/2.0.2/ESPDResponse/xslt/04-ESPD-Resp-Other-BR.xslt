...
<!--SCHEMA SETUP-->
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="ESPD Response Other Business Rules">
      <xsl:comment>
...
<!--SCHEMATRON PATTERNS-->
<svrl:text>ESPD Response Other Business Rules</svrl:text>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="text()='urn:www.cenbii.eu:transaction:biitrdm092:ver3.0'">
