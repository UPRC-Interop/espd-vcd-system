...
<!--PATTERN cl-attrb-rules-->
	...
	<!--RULE -->
<xsl:template match="cbc:TypeCode | ccv-cbc:JurisdictionLevelCode | cbc:ActivityTypeCode | cbc:LocaleCode | espd-cbc:EconomicOperatorRoleCode" mode="M10" priority="1004">
    <svrl:fired-rule context="cbc:TypeCode | ccv-cbc:JurisdictionLevelCode | cbc:ActivityTypeCode | cbc:LocaleCode | espd-cbc:EconomicOperatorRoleCode" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="espd-cbc:NaturalPersonRoleCode | espd-cbc:NaturalPersonRegistrationCountryCode" mode="M10" priority="1003">
    <svrl:fired-rule context="espd-cbc:NaturalPersonRoleCode | espd-cbc:NaturalPersonRegistrationCountryCode" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="ext:ExtensionReasonCode" mode="M10" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:PartyTypeCode | cbc:AddressTypeCode | cbc:AddressFormatCode | cbc:CountrySubentityCode" mode="M10" priority="1001">
