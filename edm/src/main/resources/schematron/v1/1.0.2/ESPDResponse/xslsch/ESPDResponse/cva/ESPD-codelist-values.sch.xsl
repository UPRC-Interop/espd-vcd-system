...
<rule context="ccv-cbc:JurisdictionLevelCode">
  ...
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e30'"/></xslo:call-template>(contains(translate('EU_REGULATIONEU_DIRECTIVEEU_DECISIONNATIONAL_LEGISLATIONSUBNATIONAL_LEGISLATION','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>
...
<rule context="cbc:ActivityTypeCode">
  ...
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e16'"/></xslo:call-template>(contains(translate('ABCDEFGHIJKLMNPRSTUW89Z','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>
...
<rule context="cbc:LocaleCode">
  ...
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e40'"/></xslo:call-template>(contains(translate('PLPTELENESETFIROGAFRSKSLSVHUITLTLVMTBGNLDACSDEHR','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>
...
<rule context="cbc:ContractTypeCode">
  ...
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e21'"/></xslo:call-template>(contains(translate('12345678','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>
...
<rule context="cac:Country/cbc:IdentificationCode">
  ...
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e24'"/></xslo:call-template>(contains(translate('ADAEAFAGAIALAMAOAQARASATAUAWAXAZBABBBDBEBFBGBHBIBJBLBMBNBOBQBRBSBTBVBWBYBZCACCCDCFCGCHCICKCLCMCNCOCRCUCVCWCXCYCZDEDJDKDMDODZECEEEGEHERESETFIFJFKFMFOFRGAGBGDGEGFGGGHGIGLGMGNGPGQGRGSGTGUGWGYHKHMHNHRHTHUIDIEILIMINIOIQIRISITJEJMJOJPKEKGKHKIKMKNKPKRKWKYKZLALBLCLILKLRLSLTLULVLYMAMCMDMEMFMGMHMKMLMMMNMOMPMQMRMSMTMUMVMWMXMYMZNANCNENFNGNINLNONPNRNUNZOMPAPEPFPGPHPKPLPMPNPRPSPTPWPYQARERORSRURWSASBSCSDSESGSHSISJSKSLSMSNSOSRSSSTSVSXSYSZTCTDTFTGTHTJTKTLTMTNTOTRTTTVTWTZUAUGUMUSUYUZVAVCVEVGVIVNVUWFWSXKYEYTZAZMZW','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>

<rule context="cbc:CurrencyCode">
  <!--{}[cctsV2.01-code](CurrencyCodeList)-->
  <xslo:text xml:space="preserve">
      </xslo:text><xslo:comment>{}[cctsV2.01-code](CurrencyCodeList)</xslo:comment>
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e33'"/></xslo:call-template>(contains(translate('AEDAFNALLAMDANGAOAARSAUDAWGAZNBAMBBDBDTBGNBHDBIFBMDBNDBOBBOVBRLBSDBTNBWPBYRBZDCADCDFCHECHFCHWCLFCLPCNYCOPCOUCRCCUPCVECYPCZKDJFDKKDOPDZDEEKEGPERNETBEURFJDFKPGBPGELGHSGIPGMDGNFGTQGYDHKDHNLHRKHTGHUFIDRILSINRIQDIRRISKJMDJODJPYKESKGSKHRKMFKPWKRWKWDKYDKZTLAKLBPLKRLRDLSLLTLLVLLYDMADMDLMGAMKDMMKMNTMOPMROMTLMURMVRMWKMXNMXVMYRMZNNADNGNNIONOKNPRNZDOMRPABPENPGKPHPPKRPLNPYGQARRONRSDRUBRWFSARSBDSCRSDGSSPSEKSGDSHPSKKSLLSOSSRDSTDSYPSZLTHBTJSTMMTNDTOPTRYTTDTWDTZSUAHUGXUSDUSNUSSUYUUZSVEBVNDVUVWSTXAFXAGXAUXBAXBBXBCXBDXCDXDRXFOXFUXOFXPDXPFXPTXTSXXXYERZARZMKZWD','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>
...
<rule context="cbc:ProcurementTypeCode">
  ...
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e47'"/></xslo:call-template>(contains(translate('123C46TVAAMIVDLLOV9','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>
...
<rule context="espd-cbc:EconomicOperatorRoleCode">
  ...
  <assert><xslo:attribute name="test">( false() or ( <xslo:call-template name="d2e71"><xslo:with-param name="values-id" select="'d2e61'"/></xslo:call-template>(contains(translate('MTSCCLCMJVSMEOTH','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),concat('',translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'')) ) ) ) </xslo:attribute>Invalid value: '<value-of select="."/>' for the element or invalid codelist used</assert>
</rule>
<!--
...
<!--{}(AmountTypeCode)-->
<ccs:Identification xml:id="d2e19">
...
<!--{}(ContractType)-->
<ccs:Identification xml:id="d2e21">
...
<!--{}(CountryCodeIDs)-->
<ccs:Identification xml:id="d2e24">
...
<!--{}(CriteriaTypeCode)-->
<ccs:Identification xml:id="d2e27">
...
<!--{}(CurrencyCodeList)-->
<ccs:Identification xml:id="d2e33">
...
<!--{}(CustomizationID)-->
<ccs:Identification xml:id="d2e36">
...
<!--{}(LanguageCodeEU)-->
<ccs:Identification xml:id="d2e40">
...
<ccs:Identification xml:id="d2e43">
...
<!--{}(PeriodtypeCodes)-->
<ccs:Identification xml:id="d2e45">
...
<!--{}(ProcedureType)-->
<ccs:Identification xml:id="d2e47">
...
<ccs:Identification xml:id="d2e57">
...
<ccs:Identification xml:id="d2e59">
...
<ccs:Identification xml:id="d2e61">
